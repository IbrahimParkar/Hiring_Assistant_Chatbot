# Prompt to check if a Candidate's answer is relevant to the given question
...
# Prompt to check if a given value is contextually appropriate for a job application field
...
# Generates the first technical interview question based on the Candidate's desired position, tech stack, and experience
...
# Generates a follow-up technical question based on the previous question, candidate's corresponding answer and their profile
